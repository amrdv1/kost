...
const badWordsRegex = new RegExp('(ху[йяеёил]|пизд|еба[тлн]|ёба|бля[дт]|шлюх|сук[аи]|пидор|пидар|підар|педик|гондон|гандон|мудак|залуп|дроч|хуе|чмо|говн|гавн|уеб|долбо|манд|лох|мраз|курв|гнид|падл|вибляд|выбляд|даун|дебил|дебіл|шмар|шалав|ублюд|хер|хєр|сперм|порно|жоп|срак)', 'gi');

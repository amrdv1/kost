...
const badWordsRegex = new RegExp('(ху[йяеёил]|пизд|еба[тлн]|ёба|бля[дт]|шлюх|сук[аи]|пидор|пидар|підар|педик|гондон|гандон|мудак|мадк|залуп|дроч|хуе|чмо|говн|гавн|уеб|долбо|манд|лох|мраз|курв|гнид|падл|вибляд|выбляд|даун|дебил|дебіл|шмар|шалав|ублюд|хер|хєр|сперм|порно|жоп|срак|негр|ниг+е?р|ніг+е?р|чурк|хач|жид|конч|сос|соса|чупа|fuck|shit|bitch|cunt|whore|slut|fag|nigg+[ae]r?|nigg+a+|dick|cock|pussy|asshole|retard|jews?|kike|chink|spic|gook|nazi|hitler)', 'gi');
